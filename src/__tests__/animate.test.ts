...
it('执行动画', () => {
  ...
  expect(handleUpdate).toHaveBeenNthCalledWith(1, 16);
  expect(handleUpdate).toHaveBeenNthCalledWith(2, 32);
  expect(handleUpdate).toHaveBeenNthCalledWith(3, 48);
  expect(handleUpdate).toHaveBeenNthCalledWith(4, 64);
  expect(handleUpdate).toHaveBeenNthCalledWith(5, 80);
  expect(handleUpdate).toHaveBeenNthCalledWith(6, 96);
  expect(handleUpdate).toHaveBeenLastCalledWith(100);
});
